...
*              - const kyber_poly *a: pointer to input polynomial
**************************************************/
...
*
* Arguments:   - kyber_poly *r: pointer to output polynomial
...
*              - const kyber_poly *a: pointer to input polynomial
**************************************************/
void kyber_poly_tomsg(uint8_t msg[KYBER_INDCPA_MSGBYTES], const kyber_poly *a)
{
  unsigned int i,j;
  uint32_t t;
...
/*************************************************
* Name:        kyber_poly_basemul_montgomery
*
* Description: Multiplication of two polynomials in NTT domain
*
* Arguments:   - kyber_poly *r: pointer to output polynomial
*              - const kyber_poly *a: pointer to first input polynomial
*              - const kyber_poly *b: pointer to second input polynomial
**************************************************/
...
/*************************************************
* Name:        kyber_poly_tomont
*
* Description: Inplace conversion of all coefficients of a polynomial
*              from normal domain to Montgomery domain
*
* Arguments:   - kyber_poly *r: pointer to input/output polynomial
**************************************************/
