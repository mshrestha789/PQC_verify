...
*              kyber_polyvec *pk: pointer to the input public-key polyvec
...
*
* Arguments:   - kyber_polyvec *pk: pointer to output public-key polynomial vector
*              - uint8_t *seed: pointer to output seed to generate matrix A
*              - const uint8_t *packedpk: pointer to input serialized public key
**************************************************/
static void unpack_pk(kyber_polyvec *pk,
                      uint8_t seed[KYBER_SYMBYTES],
                      const uint8_t packedpk[KYBER_INDCPA_PUBLICKEYBYTES])
{
  kyber_polyvec_frombytes(pk, packedpk);
...
**************************************************/
static void pack_sk(uint8_t r[KYBER_INDCPA_SECRETKEYBYTES], kyber_polyvec *sk)
{
...
**************************************************/
static void unpack_sk(kyber_polyvec *sk, const uint8_t packedsk[KYBER_INDCPA_SECRETKEYBYTES])
{
...
*              kyber_poly *pk: pointer to the input vector of polynomials b
*              kyber_poly *v: pointer to the input polynomial v
**************************************************/
static void pack_ciphertext(uint8_t r[KYBER_INDCPA_BYTES], kyber_polyvec *b, kyber_poly *v)
{
...
**************************************************/
static void unpack_ciphertext(kyber_polyvec *b, kyber_poly *v, const uint8_t c[KYBER_INDCPA_BYTES])
{
...
void gen_matrix(kyber_polyvec *a, const uint8_t seed[KYBER_SYMBYTES], int transposed)
{
                ...
                const uint8_t coins[KYBER_SYMBYTES])
{
  ...
  for(i=0;i<KYBER_K;i++)
    kyber_poly_getnoise_eta1(sp.vec+i, coins, nonce++);
  for(i=0;i<KYBER_K;i++)
    kyber_poly_getnoise_eta2(ep.vec+i, coins, nonce++);
